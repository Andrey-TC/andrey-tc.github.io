# ANDREY VILLEGAS
Términos y condiciones del servicio de tatuaje realista.

### Sobre el pago inicial 
- Para iniciar el proceso y agendar cita, se requiere un pago parcial del 50% del valor del tatuaje.
- El pago **no es reembolsable ni trasladable** y garantiza: 
  - Preparación de la fotografía para su correcta reproducción en la piel.
...
---
### Reprogramaciones y llegada tarde
- Las citas pueden reprogramarse con al menos 48 horas de anticipación sin costo. 
- Tienes un tiempo de llegada tarde de hasta 59 minutos.
### Propiedad intelectual y difusión
- Todo tatuaje realizado es obra del artista, quien se reserva el derecho de difundir imágenes del trabajo con fines artísticos o promocionales.
- Si el cliente desea total privacidad, puede solicitarlo antes de la cita. 
### Salud y responsabilidad 
- El cliente declara que se encuentra en buen estado de salud para recibir un tatuaje.
- No se tatuarán personas embarazadas o con condiciones médicas que lo contraindiquen.
- No se tatuarán personas bajo efectos de alcohol/drogas.
